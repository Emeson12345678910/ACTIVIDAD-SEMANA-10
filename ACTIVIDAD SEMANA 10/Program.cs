...
switch (Menu)
{
    ...
    case 1:
        ...
        while (bucle == 1)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("##EL PRODUCTO INGRESADO SE REGISTRO CORRECTAMENTE##");
            Console.WriteLine();
            Console.WriteLine("=> Pulsa 1 para continuar ingresando productos");
    ...
    case 2:
        ...
        while (bucle2 == 2) {
            ...
            {
                Console.WriteLine("El producto es existente");
                Console.WriteLine();
            }
            else
            {
                ...
                Console.WriteLine("Presione 2 para actualizar La descripcion de el producto");
                ...
                {
                    Console.Write("Ingrese una descripcion nueva:");
